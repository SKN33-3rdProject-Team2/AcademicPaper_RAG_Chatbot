...
RAG_PROMPT = ChatPromptTemplate.from_messages(
    [
        (
            ...
            # 논문 본문은 영어인데 질문은 한국어로 온다. 사용자가 "어텐션",
            # "트랜스포머" 처럼 외래어를 한글로 적으면 원어를 함께 떠올려야
            # 근거에서 그 대목을 찾을 수 있다.
            "질문에 한글로 적힌 외래어가 있으면 그에 해당하는 영어 용어로도 "
            "이해하고 근거를 찾으세요. 예를 들어 '어텐션'은 attention, "
            "'트랜스포머'는 Transformer 로 봅니다. "
